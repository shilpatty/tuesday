...
## Environments
- Preview: https://main--tuesday--shilpatty.aem.page/
- Live: https://main--tuesday--shilpatty.aem.live/
...
1. Open the `tuesday` directory in your favorite IDE and start coding :)
